...
export default function Home() {
  return (
    <div id="about" class="about">
        ...
        <div class="about-title">My journey</div>
        ...
        <div class="about-body">
          <div class="about-text">
            ...
            Maecenas consequat nunc eu lectus suscipit mollis. Donec vitae luctus turpis, et porttitor felis. Duis venenatis posuere pharetra. Vivamus euismod lorem sit 
            amet magna rutrum finibus. Pellentesque auctor, nulla id feugiat imperdiet, diam risus consectetur lacus, quis ultrices eros lorem ut nulla. 
            Sed blandit dolor sit amet nulla posuere congue. Vestibulum sagittis a erat at luctus. Duis aliquam iaculis eros quis molestie. Sed arcu mauris, 
            facilisis sed magna quis, hendrerit dignissim felis. Ut a mauris porta, porta leo at, consequat enim. Fusce sit amet dolor sollicitudin, cursus sapien eget, 
